...
public class PeerUpdater extends Thread
{
	...
	public synchronized Map contactTracker(byte[] id, TorrentFile t, long dl, long ul, long left, String event)
	{
		try
		{
			...
			//this.rate.setText("Cоединение установлено");
		...
		catch (MalformedURLException murle)
		{
			...
			this.rate.setText("URL трекера не действителен... Проверьте данные на корректность");
		}
		catch (UnknownHostException uhe)
		{
			this.fireUpdateFailed(3, "Tracker not available... Retrying...");
			this.rate.setText("Трекер недоступен... Переподключение");
		}
		...
		catch (Exception e)
		{
			...
			this.rate.setText("Внутренняя ошибка");
		}
		return null;
	}
